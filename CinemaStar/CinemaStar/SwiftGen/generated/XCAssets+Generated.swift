...
enum Asset {
    ...
    enum Colors {
        static let descriptionText = ColorAsset(name: "descriptionText")
        static let gradientBottomColor = ColorAsset(name: "gradientBottomColor")
        static let gradientTopColor = ColorAsset(name: "gradientTopColor")
        static let shimmerColor = ColorAsset(name: "shimmerColor")
    }
}
